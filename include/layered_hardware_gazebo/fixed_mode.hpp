#ifndef LAYERED_HARDWARE_GAZEBO_FIXED_MODE_HPP
#define LAYERED_HARDWARE_GAZEBO_FIXED_MODE_HPP
...
class FixedMode : public OperationModeBase {
public:
  FixedMode(const urdf::Joint &desc, const gzp::JointPtr joint)
      : OperationModeBase("fixed", joint),
